...
import { generatePostSchema, updatePostSchema } from '../validation/validation';
const router = Router();
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/generate', validateRequest(generatePostSchema), (req, res) => postController.generateBulkPosts(req as any, res));
